#############################################################################
# Makefile for building: lmfab100
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  lmfab100.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile lmfab100.pro
#############################################################################
...
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -I. -I/usr/include/qt5 -I/usr/include/qt5/QtMultimediaWidgets -I/usr/include/qt5/QtMultimedia -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1 -Wl,-rpath-link,/usr/lib/x86_64-linux-gnu
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -dsengine -lQt5MultimediaWidgets -L/usr/lib/x86_64-linux-gnu -lQt5Multimedia -lQt5Widgets -lQt5Network -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: lmfab100.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/lmfab1001.0.0 || mkdir -p .tmp/lmfab1001.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/lmfab1001.0.0/ && $(COPY_FILE) --parents clavier.h jo.h convertisseur.h AdnForme.h .tmp/lmfab1001.0.0/ && $(COPY_FILE) --parents main.cpp clavier.cpp fronts.cpp convertisseur.cpp Adnforme.cpp .tmp/lmfab1001.0.0/ && (cd `dirname .tmp/lmfab1001.0.0` && $(TAR) lmfab1001.0.0.tar lmfab1001.0.0 && $(COMPRESS) lmfab1001.0.0.tar) && $(MOVE) `dirname .tmp/lmfab1001.0.0`/lmfab1001.0.0.tar.gz . && $(DEL_FILE) -r .tmp/lmfab1001.0.0
